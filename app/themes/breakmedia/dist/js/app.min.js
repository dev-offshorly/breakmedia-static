	...
	const wh = {
		...
		'common': {
			...
			init: function() {
				...
				// about us slider
				$('.about-us-slider .uk-slider-items li').on('beforeitemshow', function(){
					if ($(this).index() == 0) {
						$('.about-us-slider .uk-slidenav-previous').addClass('active');
						$('.about-us-slider .uk-slidenav-next').removeClass('active');
					} else {
						$('.about-us-slider .uk-slidenav-next').addClass('active');
						$('.about-us-slider .uk-slidenav-previous').removeClass('active');
					}
					$('.about-us-slider .outer-slider .slide-items li.slide-'+$(this).index()).fadeIn();
				});
				$('.about-us-slider .uk-slider-items li').on('itemhide', function(){
					$('.about-us-slider .outer-slider .slide-items li.slide-'+$(this).index()).fadeOut();
				});

				$('.about-us-slider .outer-slider .slide-items .animate-element').on('inview', function(){
					$(this).parent('div').removeAttr('uk-scrollspy');
					$(this).removeClass('uk-scrollspy-inview');
					$(this).removeClass('uk-animation-slide-bottom-medium');
					$(this).removeClass('uk-animation-slide-right-small');
				});

				function about_us_slider_auto_height() {
					const slider_height = $('.about-us-slider .slider.uk-slider').outerHeight();
					$('.about-us-slider .outer-slider li').css('height', slider_height+'px');
				}
				$(document).ready(about_us_slider_auto_height);
				$(window).on('resize',about_us_slider_auto_height);

				// content tabs
				function content_tabs_items_equal_height() {
					var highest = null;
					var hi = 0;
					$('.content-tabs .uk-switcher > div').each(function() {
						var h = $(this).height();
						if(h > hi){
							hi = h;
							highest = $(this).height();
					...
					$('.content-tabs .uk-switcher').height( highest );
				}
				$(document).ready(content_tabs_items_equal_height);
				$(window).on('resize',content_tabs_items_equal_height);
				...
				$(document).ready(function(){
					...
					$(".homepage-video").on("timeupdate", function(){
						const current_time = Math.ceil(this.currentTime);

						// main title 1
						if ( $(this).hasClass('looped') ) {
							if ( current_time == 2 ) {
								$('#main-title-1').addClass('animation-slide-top-medium-out');
							}
						}
						if ( current_time == 4 ) {
							$('#main-title-1').addClass('animation-fade-out');
							$('#main-title-1').removeClass('animation-slide-top-medium-out');
						}

						// main title 2
						if ( current_time == 7 ) {
							$('#main-title-2').addClass('animation-slide-top-medium-out');
						}
						if ( current_time == 9 ) {
							$('#main-title-2').addClass('animation-fade-out');
							$('#main-title-2').removeClass('animation-slide-top-medium-out');
						}

						// // main title 3
						if ( current_time == 12 ) {
							$('#main-title-3').addClass('animation-slide-top-medium-out');
						}
						if ( current_time == 14 ) {
							$('#main-title-3').addClass('animation-fade-out');
							$('#main-title-3').removeClass('animation-slide-top-medium-out');
						}
					});
				});

				// disable input of letter on tel field type
				$('.wpcf7-form input[type=tel]').on('keyup', function() {
					$(this).val($(this).val().replace(/([a-zA-Z])/g, ""));
				});

				function uk_scroll_offset() {
					$('a[uk-scroll]').each(function() {
						if ($(window).width() < 961) {
							$(this).attr('uk-scroll', 'offset: 82');
						} else {
							$(this).attr('uk-scroll', '');
						}
					});
				}
				$(document).ready(uk_scroll_offset);
				$(window).on('resize',uk_scroll_offset);
